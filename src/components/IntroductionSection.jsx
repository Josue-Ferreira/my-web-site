        ...
        <Section>
            ...
            <Welcome>
                <Hello id="welcome-text">
                    ...
                    <Button href='../../public/CV.pdf' download>{textLang[language].pages.home.cv}</Button>
                </Hello>
                <ImgPhotoProfil id="photo-profil" src='../../public/photo_profil.resized.png' alt="Josué Ferreira photo" title="Josué Ferreira"/>
            </Welcome>
            <Links>
                <a href="https://github.com/Josue-Ferreira" target="_blank">
                    <ImgLink src='../../public/logos/github.png' alt="GitHub link" title='Link to GitHub'/>
                </a>
                <a href="https://www.linkedin.com/in/josué-ferreira-694095276" target="_blank">
                    <ImgLink src='../../public/logos/linkedin.png' alt="LinkedIn link" title='Link to LinkedIn' />
                </a>
